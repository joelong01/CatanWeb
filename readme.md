...
9. **COMMENT RULES**: we do not embed comments that give history.  comments are there to tell what it *does*.  There can be exceptions when the logic is difficult and we want to explain
why something works the way it does, we can add a comment with a date and what the bug was and the fix we are making.
