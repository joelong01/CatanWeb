...
namespace Catan3.Models
{
    ...
    {
        public ExpansionBoardInfo() => Layout = new BoardLayout(ColumnCount);
        ...
        public List<HarborModel> HarborModels { get; } = [
            new HarborModel(new HexCoordinates(-3, 3, 0), HarborType.Ore, HexSide.TopLeft),
            new HarborModel(new HexCoordinates(0, -3, 3), HarborType.Wheat, HexSide.Top),
            new HarborModel(new HexCoordinates(1, -3, 2), HarborType.Wood, HexSide.TopRight),
            new HarborModel(new HexCoordinates(2, -3, 1), HarborType.Brick, HexSide.TopRight),
            ...
            new HarborModel(new HexCoordinates(-2, -1, 3), HarborType.ThreeForOne, HexSide.TopLeft),
