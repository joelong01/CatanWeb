...
### Step 1.2 - `[ ]` Create Zustand theme store
...
### Step 1.5 - `[ ]` Create modern theme.json
...
### Step 2.1 - `[ ]` Migrate board-assets.ts to use themeStore
...
### Step 2.2 - `[ ]` Build and verify Classic is identical
...
### Step 3.1 - `[ ]` Add ThemeSection to NavMenu
...
### Step 3.2 - `[ ]` Build and verify theme switching
...
### Step 4.1 - `[ ]` Add font rendering branch to GameTile
...
### Step 4.2 - `[ ]` Build and verify tiles
...
### Step 5.1 - `[ ]` Remove HARBOR_FONT_CONFIG from GameBoard
...
### Step 5.2 - `[ ]` Remove fontRendering prop from controls-test
...
### Step 5.3 - `[ ]` Build and final verification
...
### Step 6.1 - `[ ]` Create themes.ps1 script
...
| `react-ui/lib/constants/board-assets.ts` | MODIFY | 2 |
| `react-ui/components/layout/NavMenu.tsx` | MODIFY | 3 |
| `react-ui/components/game/tiles/GameTile.tsx` | MODIFY | 4 |
| `react-ui/components/game/board/GameBoard.tsx` | MODIFY | 5 |
...
before removing the old prop). Phase 6 can run any time after Phase 1.
